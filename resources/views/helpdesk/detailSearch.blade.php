            ...
            <div class="site-hero clearfix">
                <div class="container">
                    <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="active">
                            <i class="fas fa-chevron-right"></i>
                            Aliquam Rhoncus Quis Mi Nec Sodales
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div id="content" class="site-content col-md-9">
                                <article class="hentry">
                                    <header class="entry-header">
                                        <h1 class="entry-title">Aliquam Rhoncus Quis Mi Nec Sodales</h1>
                                    ...
                                    <div class="entry-content clearfix">
                                        ...
                                        <pre>
                                            .
                                            <span class="text-danger">form-group</span>
                                            {
                                ...
                                <div id="comments" class="comments-area">
                                    ...
                                    <div id="respond" class="comment-respond form-border">
                                        ...
                                        >
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="banner-wrapper user-data text-center clearfix">
                                                        <img
                                                            src="assets/img/avatar.png"
                                                            alt=""
                                                            height="50"
                                                        ...
                                                        <div class="banner-content">
                                                            <p>
                                                                ...
                                                                ?
                                                                <br>
                                                                <a href="#" class="btn btn-custom btn-sm">Log out</a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
